...
var _donotsync = __webpack_require__(26);

var _donotsync2 = _interopRequireDefault(_donotsync);
...
// }
console.log('token = ' + _donotsync2.default);
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function grabPosts() {
      ...
      _superagent2.default.get('' + this.state.url + this.state.AT).then(function (res) {
        _this2.setState({
          name: res.body.name,
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: this.state.image, alt: 'FB image of post' }),
        _react2.default.createElement(
          'a',
          { href: this.state.linkPost },
          'Click to view this post on FB'
        )
      );
    }
  }]);
...
const Emitter = __webpack_require__(21);
const RequestBase = __webpack_require__(22);
const isObject = __webpack_require__(5);
const ResponseBase = __webpack_require__(23);
const Agent = __webpack_require__(25);
...
var token = 'EAADyzgYg3UoBANeOkMD5HO12A4mkwpTF0XZAL09lam5TVI7ZA40LinbCUu1xfE4yBmmWPUHDzfzT7Yi6668YHSWlspf4y5XObUqZCBwDx6QSDKtnfBIvdZBy9moIp4gvyZBsbZA9Gg9nlPW3Pxb4ItNne4dhKVaZAIOgwPLOWD7HPFZCymOktAAZAzVVGA8S8QhW2yQGAxTEunQZDZD';
